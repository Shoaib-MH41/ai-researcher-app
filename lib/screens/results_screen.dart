...
class ResultsScreen extends StatelessWidget {
  ...
  Widget _buildLanguageOption(String langCode, String language, String flag, Color color) {
    return Card(
  ...
  void _saveAsPDF(BuildContext context) {
    // پرانا function - اب یہ language dialog کو call کرے گا
    _showPDFLanguageDialog(context);
  }
  ...
  void _shareResults(BuildContext context) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('شیئر فیچر جلد آ رہا ہے'),
